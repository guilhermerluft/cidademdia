...
grep -q '/tmp/source-ready' "$ROOT/infra/scripts/deploy-production-stack.sh"
grep -q 'production_migrator_source=READY' "$ROOT/infra/scripts/deploy-production-stack.sh"
grep -q 'CidadeEmDia.Api/CidadeEmDia.Api.csproj' "$ROOT/infra/scripts/deploy-production-stack.sh"
grep -q 'migrator_source=READY' "$ROOT/infra/scripts/apply-migrations.sh"
